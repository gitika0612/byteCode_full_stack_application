...
const NoSearchResults = () => {
    return (
        <div className="flex flex-col items-center text-center p-8 justify-center">
            <div className="mb-4 rounded-full bg-muted p-4">
                <Search className="w-8 h-8" />
            </div>
            <h1 className="font-bold">No Result Found...</h1>
            <p className="mt-2 text-sm">We could not find any articles matching your search. Try a different keywords or phase.</p>
        </div>
    )
}